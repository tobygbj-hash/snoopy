...
| [../pi/MVP.md](../pi/MVP.md) | **Start here on the Pi** — minimum setup, optional steps |
| [../pi/WHEN-YOU-GET-YOUR-PI.md](../pi/WHEN-YOU-GET-YOUR-PI.md) | Short checklist when the Pi arrives |
